...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Page Not Found - {{ setting('general.title') }}</title>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-5 col-8">
                        <div class="text-center">
                            ...
                            <div>
                                <img src="{{ admin_asset('images/not-found.png') }}" alt="" class="img-fluid" />
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <h3 class="mt-3">Oops, there is nothing to do here</h3>
